...
def put_in_functions_a():
    try:
        ...
        FUNCTION_HEADER = (
            "def %s(yearly_salary, portion_saved, cost_of_dream_home):"
            % (FUNCTION_NAME)
        )
        ...
        print(
            "[PART A] Did you keep all the original comments the file came with? Did you initialize variables at the right places?"
        )
...
def put_in_functions_b():
    try:
        ...
        FUNCTION_HEADER = (
            "def %s(yearly_salary, portion_saved, cost_of_dream_home, semi_annual_raise):"
            % (FUNCTION_NAME)
        )
        ...
        print(
            "[PART B] Did you keep all the original comments the file came with? Did you initialize variables at the right places?"
        )
...
def put_in_functions_c():
    try:
        ...
        print(
            "[PART C] Did you keep all the original comments the file came with? Did you initialize variables at the right places?"
        )
